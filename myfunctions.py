...
def pow_many(power, *args):
    ...
    """
    # AV: чтобы избежать аварии, будем работать только с целыми.
    #     если степень не целое, то примем её равной 1,
    #     также, в сумме будут складываться только целые числа
    m_power = 1
    if int == type(power):
        m_power = power
    m_summa = 0
